...
export default function ControlPage() {
  ...
  const kickIntegration=platformIntegrations.find((item)=>item.platform==="KICK");
  ...
  return <main className="control-dashboard control-dashboard-v2">
    ...
    <section className="control-workspace" onInputCapture={(event)=>{const form=(event.target as HTMLElement).closest<HTMLFormElement>("form[data-control-form]");if(form?.dataset.controlForm)markFormDirty(form.dataset.controlForm)}} onChangeCapture={(event)=>{const form=(event.target as HTMLElement).closest<HTMLFormElement>("form[data-control-form]");if(form?.dataset.controlForm)markFormDirty(form.dataset.controlForm)}}>
